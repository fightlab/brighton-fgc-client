          ...
          <TabContainer dir={theme.direction}>
            <Card className={classes.card}>
              ...
              >
                ...
                <p>Your privacy is important to us. It is Habrewken - Brighton Fighting Game Community's policy to respect your privacy regarding any information we may collect from you across our website, <a href='https://hbk.gg'>https://hbk.gg</a>, and other sites we own and operate.</p>
                ...
                <p>The personal information we collect is stored and processed in United Kingdom, or where we or our partners, affiliates and third-party providers maintain facilities. By providing us with your personal information, you consent to the disclosure to these overseas third parties.</p>
                ...
                <p><strong>Habrewken - Brighton Fighting Game Community Data Controller</strong><br />
Mahesh Makani<br />
contact@mkn.sh</p>
                <p>This policy is effective as of 2 March 2019.</p>
          ...
          <TabContainer dir={theme.direction}>
            <Card className={classes.card}>
              <CardContent
                className={classes.cardContent}
              >
                <h2>Habrewken - Brighton Fighting Game Community Terms of Service</h2>
                <h3>1. Terms</h3>
                <p>By accessing the website at <a href='https://hbk.gg'>https://hbk.gg</a>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</p>
                <h3>2. Use License</h3>
                <ol type='a'>
                  <li>Permission is granted to temporarily download one copy of the materials (information or software) on Habrewken - Brighton Fighting Game Community's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                    <ol type='i'>
                      <li>modify or copy the materials;</li>
                      <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
                      <li>attempt to decompile or reverse engineer any software contained on Habrewken - Brighton Fighting Game Community's website;</li>
                      <li>remove any copyright or other proprietary notations from the materials; or</li>
                      <li>transfer the materials to another person or "mirror" the materials on any other server.</li>
                    </ol>
                  </li>
                  <li>This license shall automatically terminate if you violate any of these restrictions and may be terminated by Habrewken - Brighton Fighting Game Community at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.</li>
                </ol>
                <h3>3. Disclaimer</h3>
                <ol type='a'>
                  <li>The materials on Habrewken - Brighton Fighting Game Community's website are provided on an 'as is' basis. Habrewken - Brighton Fighting Game Community makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</li>
                  <li>Further, Habrewken - Brighton Fighting Game Community does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.</li>
                </ol>
                <h3>4. Limitations</h3>
                <p>In no event shall Habrewken - Brighton Fighting Game Community or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Habrewken - Brighton Fighting Game Community's website, even if Habrewken - Brighton Fighting Game Community or a Habrewken - Brighton Fighting Game Community authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p>
                <h3>5. Accuracy of materials</h3>
                <p>The materials appearing on Habrewken - Brighton Fighting Game Community's website could include technical, typographical, or photographic errors. Habrewken - Brighton Fighting Game Community does not warrant that any of the materials on its website are accurate, complete or current. Habrewken - Brighton Fighting Game Community may make changes to the materials contained on its website at any time without notice. However Habrewken - Brighton Fighting Game Community does not make any commitment to update the materials.</p>
                <h3>6. Links</h3>
                <p>Habrewken - Brighton Fighting Game Community has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Habrewken - Brighton Fighting Game Community of the site. Use of any such linked website is at the user's own risk.</p>
                <h3>7. Modifications</h3>
                <p>Habrewken - Brighton Fighting Game Community may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.</p>
          ...
          <TabContainer dir={theme.direction}>
            <Card className={classes.card}>
              ...
              >
                <h2>Cookie Policy</h2>
                <p>We use cookies to help improve your experience of <a href='https://hbk.gg'>https://hbk.gg</a>. This cookie policy is part of Habrewken - Brighton Fighting Game Community's privacy policy, and covers the use of cookies between your device and our site. We also provide basic information on third-party services we may use, who may also use cookies as part of their service, though they are not covered by our policy.</p>
                <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <a href='https://hbk.gg'>https://hbk.gg</a>, with the understanding that we may be unable to provide you with some of your desired content and services.</p>
